    ...
    >
      ...
      >
        <motion.div
          ...
          className="w-5 h-8 rounded-full border border-brand-pearl/20 flex items-start justify-center pt-1.5"
        >
          <div className="w-1 h-2 rounded-full bg-brand-pearl/40" />
        </motion.div>
      </motion.div>
    </section>
  )
